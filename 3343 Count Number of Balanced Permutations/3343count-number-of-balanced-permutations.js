...
// could not solve, this question involves math and picking numbers
// idea is total sum / 2 is the sum of the two halfs. the total has to be even or else  dividing into half is not possible. next is count the frequency of all numbers andfind all the possible valid combinations of each of these numbers to go into the odd and even indices that are valid.

// still do not understand the solution
